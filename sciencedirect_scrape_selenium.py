...
for ii in range(start_vol, end_vol+1): 
    # print(i)
    for j in range (1,13):
        issue_urls_unrefined.append("https://www.sciencedirect.com/journal/journal-of-business-research/vol/{0}/issue/{1}".format(ii, j))
...
for i in issue_urls: 
    ...
    # print(i)
    for link in soup.findAll('a', attrs={ 'class':"anchor pdf-download u-margin-l-right text-s", 'target':"_blank"}):
...
for i in range(len(pdf_urls_new)):
    ...
    browser = webdriver.Chrome(executable_path = r"C:\\Users\\lanka\Desktop\\Lab\\DARPA\\Scrape_Web\\chromedriver_win32\\chromedriver.exe", 
